            ...
            <div class="row mb-2">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="product-title"><?php echo $data['page']['title'];?></h4>
                    </div>
                </div>
            </div>
                    ...
                    <form id="add-edit-page" class="mb-5" enctype="multipart/form-data">
                        ...
                        <div class="tab-content mb-5">
                            <div class="tab-pane show active" id="general">
                                <?php insertTemplate('/templates/admin/content/tabs/edit/page-general', ['mod' => $data['mod'], 'page' => $data['page'], 'products_gr' => $data['products_gr'], 'duplicate' => 0]);?>
                            </div>
                        ...
                        <?php echo csrf_field();?>
                        <button type="submit" name="submit" data-type="edit"  data-id="<?php echo $data['page_id'];?>" class="btn btn-primary">Сохранить</button>
                    </form>
