    ...
    <!-- <div class="accordion-item" data-order="0">
        <h2 class="accordion-header position-relative">
            ...
            <button class="btn position-absolute btn-del-acc-option"
                ...
                <i class="ri-add-circle-line text-danger me-1"></i>
            </button>
        </h2>
...
// foreach ($meta_acc['acc_imagesItems'] as $key => $img) {
//     echo '<pre>';
//     var_dump($img);
//     echo '</pre>';
// }

// foreach (json_decode($meta_acc['acc_imagesItems'], true) as $key => $img) {
//     echo '<pre>';
//     var_dump($img);
//     echo '</pre>';
// }
...
// echo '<pre>';
// var_dump($meta_acc['acc_imagesItems'][0][0]['link']);
// echo '</pre>';
