...
<div class="content-page">
    <div class="content">
                                ...
                                <tbody>
                                    <?php foreach ($data['posts'] as $key => $post) {
                                        ...
                                        <tr id="user<?php echo $post['id'];?>">
                                            ...
                                            <td><?php echo category_post($post['post_term']);?></td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="<?php echo $post['post_url'];?>" target="_blank" class="text-reset fs-16 px-1" data-state="def" data-id="user<?php echo $user['id']?>" title="Смотреть">
                                                    <i class="ri-eye-line"></i>
                                                </a>
                                                <a href="/<?php echo $data['mod'];?>/post-edit?id=<?php echo $post['id'];?>" class="text-reset fs-16 px-1 js-user-settings" data-id="user<?php echo $user['id']?>" title="Редактировать">
        ...
        <?php } else { ?>
            <div class="row mb-4">
                <div class="col-12">
                    <h5 class="page-title">Записей еще нет</h5>
                </div>
            </div>
        <?php } ?>
