...
<div class="navbar-custom">
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-lg-2 gap-1">
            <div class="logo-topbar">
                <a href="/" class="logo-light">
                    ...
                    <span class="logo-sm">
                        <img src="/public/images/logo-n.png" alt="small logo">
                    </span>
                </a>
                <a href="/" class="logo-dark">
                    <span class="logo-lg">
                        <img src="/public/images/logo-n.png" alt="dark logo">
                    </span>
                    <span class="logo-sm">
                        <img src="/public/images/logo-n.png" alt="small logo">
                    </span>
        ...
        <ul class="topbar-menu d-flex align-items-center gap-3">
            ...
            <?php if (in_array(request_path(), $btn_info_urls)) { ?>
                <li class="d-md-inline-block">
                    <button type="button"
                        class="btn btn-success add-post-info"
                        data-bs-toggle="modal"
                        data-bs-target="#addPostInfo"
                        title="Инструкция">
