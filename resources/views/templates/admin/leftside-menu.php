    ...
    <a href="/" class="logo logo-light">
        <span class="logo-lg">
            <span class="logo-lg d-flex gap-2 align-items-center">
                <img src="<?php echo $home_url;?>/public/images/logo-n.png" alt="logo">
                <span class="text-logo"><?php echo $site_title;?></span>
            </span>
        </span>
        <span class="logo-sm">
            <img src="<?php echo $home_url;?>/public/images/logo-n.png" alt="small logo">
        </span>
    </a>

    <a href="/" class="logo logo-dark">
        <span class="logo-lg d-flex gap-2 align-items-center">
            <img src="<?php echo $home_url;?>/public/images/logo-n.png" alt="dark logo">
        </span>
