<?php
insertTemplate('/templates/header', ['title' => $title, 'mod' => $mod]);
$form_warning = '';
...
<div class="container">
    <div class="row login-page align-items-center justify-content-center">
        <div class="auth-form d-flex flex-column gap-4">
            ...
            <form id="auth-form" class="d-flex flex-column gap-4" action="/login" method="post">
                ...
                <div class="d-grid gap-2">
                    <button id="login-submit-s" class="btn btn-primary" type="submits">Войти</button>
                </div>
